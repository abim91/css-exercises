...
- The sidebar and cards take up all available space above the footer.(DONE, using flex-grow:1)
- The sidebar is 300px wide (and it doesn't shrink).(DONE, used flex-shrink:0; to avoid shrinking)
